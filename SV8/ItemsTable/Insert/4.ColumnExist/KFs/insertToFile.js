...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {ItemName : LocalCoumnItemName,ItemNameAlias : LocalCoumnItemNameAlias,ItemCode : LocalCoumnItemCode,Rate : LocalCoumnRate,GstPercentage : LocalCoumnGstPercentage,hsn : LocalCoumnhsn};
